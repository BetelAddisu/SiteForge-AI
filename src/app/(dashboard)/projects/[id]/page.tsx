      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="content">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Content will be generated by AI based on your project details</CardDescription>
            </CardHeader>
            <CardContent>
              {project.status === 'DRAFT' ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium">Content Generated</h3>
                  <p className="text-muted-foreground mt-2">
                    Your website content has been generated and is ready for preview.
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="preview">
          <Card>
            ...
            <CardContent>
              {project.previewImage || project.status === 'PREVIEW' ? (
                <div className="space-y-4">
                  ...
                  <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                    ...
                    <p className="text-sm text-green-700 mt-2">
                      {project.status === 'PUBLISHED' 
                        ? 'Your website has been published to WordPress.'
